...
import {ZONE_TYPE_DEFAULT, ZONE_TYPE_IN_OUT, ZONE_TYPE_PARKING, ZONE_TYPE_RESTRICTED_AREA} from "../ChangeFigure/Polygon";
...
export const SetTypeAction = observer(() => {
	...
	return (
		...
		<List>
			<ListItem button onClick={() => console.log("Inbox")}>
				<ListItemIcon>
					<InboxIcon/>
				</ListItemIcon>
